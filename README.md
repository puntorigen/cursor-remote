...
![Version 1.0.19](https://img.shields.io/badge/version-1.0.19-green.svg)
...
A prebuilt `cursor-remote-1.0.19.vsix` is included in the repository. Install it directly:

```bash
cursor --install-extension cursor-remote-1.0.19.vsix
```
