...
![Version 1.0.27](https://img.shields.io/badge/version-1.0.27-green.svg)
...
A prebuilt `cursor-remote-1.0.27.vsix` is included in the repository. Install it directly:

```bash
cursor --install-extension cursor-remote-1.0.27.vsix
```
