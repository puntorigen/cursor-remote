...
![Version 1.0.16](https://img.shields.io/badge/version-1.0.16-green.svg)
...
A prebuilt `cursor-remote-1.0.16.vsix` is included in the repository. Install it directly:

```bash
cursor --install-extension cursor-remote-1.0.16.vsix
```
